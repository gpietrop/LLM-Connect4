...
def boxplot_first_nonzero_percentage_with_median(seeds, n_generations=100, n_individuals=50, adaptive=False):
    ...
    for my_seed in seeds:
        directory_path = os.path.join(os.getcwd(),
                                      f'../results/results_{n_individuals}_{n_generations}_{adaptive}/connect4_trial_{my_seed}')
...
boxplot_first_nonzero_percentage_with_median(seeds, n_generations=100, n_individuals=100)
